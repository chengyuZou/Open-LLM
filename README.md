...
一个持续更新的，收集大模型学习路径、开源项目、实战教程与工具集合的导航仓库。如果不嫌弃，请给我点个 Star ⭐️，这是我更新的动力！

🔍 说明:
- 排名不分先后：资源主要按类别整理。
- 持续更新：作者于 2025.7 入坑，正在不断学习和补充中。
- 免责声明：内容来源于网络，若侵权请联系删除。

<details>
<summary>📅 更新日志 (Update Log)</summary>

**2025.11.24 (Fourth Update)**
- 新增三个项目
...
- [🌌 LLM 学习指南与资源导航 (LLM Learning \& Resources)](#-llm-学习指南与资源导航-llm-learning--resources)
  ...
  - [2. ⚔️ 核心实战与复现 (Core Implementation)](#2-️-核心实战与复现-core-implementation)
    ...
    - [开发者教程与手册](#开发者教程与手册)
  - [3. 🔥 AI开源项目收集](#3--ai开源项目收集)
  - [4. 🏗️ 应用开发架构 (Application Engineering)](#4-️-应用开发架构-application-engineering)
    - [Agent (智能体)](#agent-智能体)
    - [RAG (检索增强生成)](#rag-检索增强生成)
    - [应用开发实战](#应用开发实战)
  - [5. 🧩 垂直领域与多模态 (Vertical \& Multimodal)](#5--垂直领域与多模态-vertical--multimodal)
    - [多模态 (CV/Audio)](#多模态-cvaudio)
    - [垂直行业模型](#垂直行业模型)
  - [6. 🛠️ 工具链与生态 (Tools \& Ecosystem)](#6-️-工具链与生态-tools--ecosystem)
    - [核心框架与官网](#核心框架与官网)
    - [IDE 与开发工具](#ide-与开发工具)
    - [算力与炼丹平台](#算力与炼丹平台)
    - [API 服务与聚合](#api-服务与聚合)
  - [7. 🌐 社区与资讯 (Community \& News)](#7--社区与资讯-community--news)
    - [博主](#博主)
    - [博客](#博客)
  - [8. 🎮 DLC](#8--dlc)
    - [算法](#算法)
...
收集一些 AI 相关的开源项目，可在里面检索你想要的东西

| 资源名称 | 作者/组织 | 链接 | 备注 |
|---------|----------|------|------|
| AI Resource Central | CoderSJX | [Github](https://github.com/CoderSJX/AI-Resources-Central) | 汇集全球优秀的人工智能开源项目！(约1k个)|

## 4. 🏗️ 应用开发架构 (Application Engineering)
...
| awesome-claude-skills | ComposioHQ | [GitHub](https://github.com/ComposioHQ/awesome-claude-skills) | 一份精选的Claude技能、资源和定制Claude AI工作流程工具列表 |
...
| 自己手写了一个大模型RAG项目（汇总，持续更新Ing） | 程序锅 | [知乎](https://zhuanlan.zhihu.com/p/696872562) | 从0到1搭建大模型RAG问答系统 |
...
## 5. 🧩 垂直领域与多模态 (Vertical & Multimodal)
...
| Learn-by-projects | ckissi | [GitHub](https://github.com/ckissi/Learn-by-projects) | 一边做项目一边学编程 这个项目集合了大量实战型编程教程，覆盖 Python、JavaScript、C++、Go 等多种主流语言。|
